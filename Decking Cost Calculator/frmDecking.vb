' Programm Name: Decking Cost Calculator Application
' Author:        Patrick Love
' Date:          02/21/2019
...
Public Class frmDecking
    ...
    Private Sub btnClear_Click(sender As Object, e As EventArgs) Handles btnClear.Click
        ...
        ' the program. It sets the focus to the squre footage text box and
    ...
    Private Sub frmDecking_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ' It sets the focus to the square footage text box and clears the cost est. label.
